# -*- coding: utf-8 -*-
#
# APunnetofBerries documentation build configuration file, created by
# sphinx-quickstart on Fri Sep 13 11:56:40 2013.
#
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.doctest', 'sphinx.ext.intersphinx', 'sphinx.ext.todo', 'sphinx.ext.coverage', 'sphinx.ext.pngmath', 'sphinx.ext.ifconfig', 'sphinx.ext.viewcode', 'rst2pdf.pdfbuilder']
...
project = u'APunnetofBerries'
copyright = u'2013, TeamPi'

pdf_documents = [('Top', project, u'A Punnet of Berries Documentation', u'TeamPi'),]
...
htmlhelp_basename = 'APunnetofBerriesdoc'
...
man_pages = [
    (master_doc, 'apunnetofberries', u'APunnetofBerries Documentation',
     [u'TeamPi'], 1)
]
